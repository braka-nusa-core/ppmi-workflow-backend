...
export class QuotationObjectsController {
  ...
  create(
    ...
    return this.quotationObjectsService.create(quotationId, body);
  }
  ...
  update(
    ...
    return this.quotationObjectsService.update(quotationId, id, body);
  }
  ...
  delete(
    ...
    return this.quotationObjectsService.delete(quotationId, id);
  }
}
